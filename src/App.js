...
const StateLanding = lazy(() =>
  import("./components/pages/Landing/StateLanding")
);
const TopicLanding = lazy(() =>
  import("./components/pages/Landing/TopicLanding")
);
const TribeLanding = lazy(() =>
  import("./components/pages/Landing/TribeLanding")
);
const StateListing = lazy(() =>
  import("./components/pages/Listing/StateListing")
);
const TopicListing = lazy(() =>
  import("./components/pages/Listing/TopicListing")
);
const TribeListing = lazy(() =>
  import("./components/pages/Listing/TribeListing")
);
        ...
        <Fragment>
          ...
          <Suspense fallback={<PageLoader />}>
            <Switch>
              ...
              <Route
                path="/tribal-nations/:slug"
                exact
                component={TribeListing}
              />
